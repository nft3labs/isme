...
export function AuroraLogo({ size = 16, style }: { size?: number; style?: CSSProperties }) {
  return (
    ...
    >
      <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="120.283" x2="229.3247" y1="114.1049" y2="114.1049">
      ...
      <linearGradient id="d" gradientUnits="userSpaceOnUse" x1="121.1232" x2="229.3247" y1="176.9844" y2="176.9844">
      ...
      <path
        d="m121.1 136.2 105.7-1.5m-110.9 1.7-108.7 2.1m108.2-37.6c-23.4-17.9-33.3-20.7-37-17.7-10.2 8.5 27.6 63.8 12.5 77.7-4.4 4-13.5 4.9-31 6.6-5.4.5-9.9.7-12.8.7m109.7-32.5-35.9-31.4m-23.7-74.6c-.3 4.9-.1 14.6 4.9 25.3 4 8.6 9.5 14.2 13 17.3m85.8 86.4c.9-1.3 12.1-17.8 5.2-33.3-5.1-11.5-17.6-16.8-19.5-17.6-2.5-1.1-2.6-.8-14.3-4.6-7.1-2.4-10.7-3.5-13.8-4.7-4.8-1.8-14.1-5.4-24.7-12.2-3.5-2.2-8-5.4-13.1-9.6"
        fill="none"
        stroke="#98c9c0"
        strokeMiterlimit="10"
        strokeWidth="2"

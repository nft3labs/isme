...
export function OptimismLogo({ size = 16, style }: { size?: number; style?: CSSProperties }) {
  return (
    <svg version="1.1" width={size} height={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 500" fill="none">
